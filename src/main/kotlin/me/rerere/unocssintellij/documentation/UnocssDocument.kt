...
import org.apache.xmlbeans.impl.xb.xsdschema.impl.WhiteSpaceDocumentImpl.WhiteSpaceImpl
...
class UnocssDocumentTarget(
    ...
    private fun StringBuilder.appendCodeSpan(text: String, attr: TextAttributesKey) {
        HtmlSyntaxInfoUtil.appendStyledSpan(this, attr, text, DocumentationSettings.getHighlightingSaturation(true))
    }
}
